		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="side-item side-item-category">ادارة الفواتير</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoiceunpaid') }}">الفواتير الغير مدفوعه</a></li>
							{{-- <li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">الفواتير المدفوعه جزيئا</a></li> --}}
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}">اضافه منتج</a></li>
